    ...
    return function o(a, s, h) {
        ...
        8: [function (e, t, r) {
            ...
            function U(e, t, r, i, n, o) {
                ...
                for (null === n && (n = ce(t).a.b.c);
                    (r = (i = ce(t)).a.b).a === n.a;) r.c !== n && (T(K(r), r), T(K(n), r)), i.f = t.f - r.f, i.d = I(e, i.f), t.b = !0, !a && G(e, t) && (R(r, n), L(t), c(n)), a = !1, t = i, n = r;
                t.b = !0, o && V(e, t)
            }
            ...
            function N(e, t) {
                ...
                if (!v(s, e.a) && 0 <= b(s, e.a, l) || !v(h, e.a) && b(h, e.a, l) <= 0) {
                    ...
                    for (M(n.b), T(i.e, K(n)), a = (o = r = t).a.b.a;
                        (o = pe(o)).a.b.a === a;);
            ...
            (function (Nr) {
                ...
                e = this,
                    function (M) {
                        ...
                        var F, G = "function" == typeof WeakMap && new WeakMap;
                        ...
                        D.MACSTRING = function (e, t) {
                            var r = function (e) {
                                if (!F)
                                    for (var t in F = {}, B) F[t] = new String(t);
                                var r = F[e];
                                if (void 0 !== r) {
                                    if (G) {
                                        var i = G.get(r);
                            ...
                            var r = [];
                            if (Array.isArray(t))
                                for (var i = 0; i < t.length; i += 1) P.argument(e.length === t.length, "Not enough arguments given for type" + t), r = r.concat(D.OPERAND(e[i], t[i]));
                        ...
                        var gt = {
                            ...
                            fontToTable: function (e) {
                                ...
                                for (var G = mt(F), N = dt(G.encode()), V = G.fields, z = !1, H = 0; H < V.length; H += 1)
        ...
        27: [function (e, t, r) {
            ...
            m.Renderer2D = function (e, t, r) {
                ...
                if (this.drawingContext.save(), this.resetMatrix(), arguments[0] instanceof m.Image) this._pInst.image(arguments[0], 0, 0, this.width, this.height);
                else {
                    var e = this._getFill(),
                ...
                if (r instanceof m.Image) this.drawingContext.save(), this.drawingContext.setTransform(1, 0, 0, 1, 0, 0), this.drawingContext.scale(i._pixelDensity, i._pixelDensity), this.drawingContext.drawImage(r.canvas, e, t), this.drawingContext.restore(), i._pixelsDirty = !0;
                else {
                    var n = 0,
                        o = 0,
                        a = 0,
                ...
                if (this._doStroke && l.lineWidth % 2 == 1 && l.translate(.5, .5), l.beginPath(), void 0 === o) l.rect(t, r, i, n);
                else {
        ...
        63: [function (e, t, r) {
            ...
            var h = function (e, t, r, i, n, o, a) {
                ...
                var s, h, l, u, c, p = (o = void 0 === o || o) ? -2 : 0,
                ...
                if (a)
                    for (_ += f[n], h = 0; h < f[n + 1]; ++h) u = (h + 1) % f[n + 1], this.faces.push([_ + h, _ + u, _ + f[n + 1]])
            };
            x.prototype.cylinder = function (e, t, r, i, n, o) {
                ...
                if (this._assert3d("torus"), x._validateParameters("torus", arguments), void 0 === e) e = 50;
                else if (!e) return;
                if (void 0 === t) t = 10;
                else if (!t) return;
                ...
                if (!this.geometryInHash("tri")) {
                    var s = new x.Geometry(1, 1, function () {
                        var e = [];
                        e.push(new x.Vector(0, 0, 0)), e.push(new x.Vector(0, 1, 0)), e.push(new x.Vector(1, 0, 0)), this.strokeIndices = [
                            [0, 1],
                            [1, 2],
                            [2, 0]
                ...
                if (!this.geometryInHash(h)) {
                    var l = new x.Geometry(2, 2, function () {
                        this.vertices.push(new x.Vector(e, t, 0)), this.vertices.push(new x.Vector(r, i, 0)), this.vertices.push(new x.Vector(n, o, 0)), this.vertices.push(new x.Vector(a, s, 0)), this.uvs.push(0, 0, 1, 0, 1, 1, 0, 1), this.strokeIndices = [
                            [0, 1],
                            [1, 2],
                            [2, 3],
                            [3, 0]
        ...
        65: [function (e, t, r) {
            ...
            d.prototype.ambientLight = function (e, t, r, i) {
                ...
                var a, s, h, l, u = this._renderer._useLightShader();
        ...
        71: [function (e, t, r) {
            ...
            c.RendererGL.prototype.beginShape = function (e) {
                ...
                if (this.immediateMode.shapeMode === p.POINTS) this._usePointShader(), this.curPointShader.bindShader(), this._drawPoints(this.immediateMode.vertices, this.immediateMode.pointVertexBuffer), this.curPointShader.unbindShader();
